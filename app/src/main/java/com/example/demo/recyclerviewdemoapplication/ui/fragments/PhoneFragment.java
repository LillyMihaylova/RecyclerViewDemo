...
public class PhoneFragment extends Fragment implements ContactsAdapter.MyContactViewHolder.OnContactItemClick {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_fragment_phone, container, false);
